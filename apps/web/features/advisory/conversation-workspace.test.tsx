...
const { mockGetAdvisoryConversations, mockRecordTelemetry, mockUseAppState } = vi.hoisted(() => ({
  mockUseAppState: vi.fn(),
  mockRecordTelemetry: vi.fn(),
  mockGetAdvisoryConversations: vi.fn(),
}));
...
vi.mock("@/lib/api/advisory", () => ({
  getAdvisoryConversations: mockGetAdvisoryConversations,
}));
...
describe("advisory conversation workspace", () => {
  beforeEach(() => {
    ...
    mockGetAdvisoryConversations.mockResolvedValue({
      items: [
        {

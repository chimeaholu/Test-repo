...
class TelemetryService:
    ...
    def record_rollout_state_change(
        ...
        *,
        ...
        LOGGER.info(
            "admin.rollout_state_change.metric",
            extra={
    ...
    def record_telemetry_ingestion(
        self,
        *,
        service_name: str,
        actor_id: str,
        ...
        LOGGER.info(
            "admin.telemetry_ingestion.metric",
            extra={
                "service_name": service_name,
                "actor_id": actor_id,
                "country_code": country_code,

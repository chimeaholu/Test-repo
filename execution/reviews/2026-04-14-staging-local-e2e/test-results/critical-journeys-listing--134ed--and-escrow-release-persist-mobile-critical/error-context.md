...
- Name: critical-journeys.spec.ts >> listing publish, negotiation approval, and escrow release persist
- Location: tests/e2e/critical-journeys.spec.ts:29:5
...
- generic [active] [ref=e1]:
  ...
  - main [ref=e16]:
    - generic [ref=e17]:
      - heading "Seeded draft listing" [level=1] [ref=e18]
      - paragraph [ref=e19]:
        - text: "Status:"
        - strong [ref=e20]: published
      - button "Publish seeded draft listing" [ref=e22] [cursor=pointer]
```

...
- Name: critical-journeys.spec.ts >> advisory, climate, finance, traceability, and admin checks persist
- Location: tests/e2e/critical-journeys.spec.ts:50:5
...
- generic [active] [ref=e1]:
  ...
  - main [ref=e16]:
    - generic [ref=e17]:
      - heading "Advisory" [level=1] [ref=e18]
      - paragraph [ref=e19]:
        - text: "Status:"
        - strong [ref=e20]: citations_attached
      - button "Attach vetted citations" [ref=e22] [cursor=pointer]
```

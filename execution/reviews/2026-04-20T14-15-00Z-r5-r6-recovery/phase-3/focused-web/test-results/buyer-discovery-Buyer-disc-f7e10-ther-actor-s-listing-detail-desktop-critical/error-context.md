...
Locator: getByText('No visible threads yet')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByText('No visible threads yet')
    ...
    - main [ref=e15]:
      - generic [ref=e16]:
        - generic [ref=e17]:
          ...
          - paragraph [ref=e23]: buyer.1776695809410@example.com · Buyer · GH
        ...
        - generic [ref=e25]:
          - generic [ref=e26]: Trace trace-ket-negotiations-1k4byt
      ...
      - region "Sync status" [ref=e28]:
        - generic [ref=e29]:
          ...
          - paragraph [ref=e33]: "Pending items: 0. Conflicts: 0. Trace ID: trace-ket-negotiations-1k4byt."
        - generic [ref=e34]:
